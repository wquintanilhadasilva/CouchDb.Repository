...
**See the pdf document below [doc.pdf](doc.pdf)"doc.pdf" for details on how to configure and use this framework (it is very simple and easy), until I manage to dedicate time to document here on the MD about all the existing resources as well as the restrictions.**
